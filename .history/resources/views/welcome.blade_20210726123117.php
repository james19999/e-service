                      ...
                      <div class="row">
                          ...
                          <div class="row" id="courses">
                            ...
                            <div class="col-sm-6 col-md-4">
                                    <div class="thumbnail">
                                                <a href="{{ route('formationdetails',$Formation) }}"><img class=" rounded-circle img-responsive" src="{{ url('storage/image/'.$Formation->image) }}" alt="Programmer avec Python" width="120" height="120"></a>
                                                <div class="caption">
