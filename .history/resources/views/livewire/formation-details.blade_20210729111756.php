<div>
   ...
   <hr  style="text-align: center" size="1" >FORMATIONS DISPONIBLES :{{ $Formation->count() }} | <input   wire:model="search" style="padding: 5px; margin-left: 20px ; " type="search" name="" id="" placeholder="RECHERCHER " >
    <hr>
               ...
               <div class="card-body p-0">
                   <div class="portfolio-item">
                       ...
                       <div class="portfolio-overlay">
                               ...
                               @if ($format->statut==1)
                               <h4 class="text-white"><a href="{{ route('Acheter') }}">{{ $format->nom }} |  {{ $format->statut==1 ? " : $format->prix $" : "GRATUIT" }} </a>
