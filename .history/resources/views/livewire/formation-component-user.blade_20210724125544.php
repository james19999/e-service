                                    ...
                                    <div class="card-body p-0">
                                        <div class="portfolio-item">
                                            ...
                                            <div class="portfolio-overlay">
                                                ...
                                                <h4 class="text-white"><a href="javascript:void(0)"> il y'a  {{ $Formation->videos_count}} episodes </a></h4>
                                                {{-- <h4 class="text-white"><a href="javascript:void(0)">{{ $vide->video }}</a></h4> --}}
                                                @foreach ($Formation->videos as $vide )

                                                <video src="{{ url('storage/video/'.$vide->video) }}" controls class="img-fluid" alt="Clients-01">
                                                @endforeach
                                            </div>
