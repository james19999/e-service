<div>
   ...
   <hr  style="text-align: center" size="1" >FORMATIONS DISPONIBLES : {{ $Formation->count() }} | <input style="padding: 5px; margin-left: 20px ;border-block-color: #fff " type="search" name="" id="" placeholder="RECHERCHER UNE FORMATION" > <hr>
