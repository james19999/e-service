                ...
                <div class="main_features p-top-100">
                    <div class="col-md-8 col-md-offset-2 col-sm-12 col-xs-12">
                        <div class="head_title text-center">
                            <h2 style="color: rgb(166,204,240)"  >Rejoignez les meilleures formations
                                 en ligne
                               </h2>
                               <div  class="form" >

                                   <h5 id="recherche" style="color: rgb(166,204,240)" >RECHERCHER VOTRE FORMATION</h5>
                              ...
                              <div class="row" id="courses">
                                 ...
                                 <div class="col-sm-6 col-md-4">
                                         <div class="thumbnail">
                                                     ...
                                                     <div class="caption">
                                                         <h2 style="font-weight: blod; color:rgb(166,204,240);" ><a href="">Formation en : {{ $Formation->nom }}</a></h2>
