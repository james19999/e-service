        ...
        <div class="container">
            <div class="row">
                <div class="main_features p-top-100">
                    ...
                    <x-jet-input  wire:model="search"  id="password" class="block mt-1 w-full" type="search" name="search"   />
                          ...
                          <div class="row">
                              ...
                              <div class="row" id="courses">
                                 ...
                                 <div class="col-sm-6 col-md-4">
                                   ...
                                   @endforeach
                                   @else
                                     <p style="text-align: center;text-transform: uppercase; color: red; font-weight: bold;font-size: 100px" >pas de formation disponible</p>
                                   @endif
                                </div>
