                          ...
                          <div class="row">
                              ...
                              <div class="row" id="courses">
                                 ...
                                 <div class="col-sm-6 col-md-4">
                                         <div class="thumbnail">
                                                     <a href="{{ route('formationdetails',$Formation) }}"><img class=" img-responsive" src="{{ url('storage/image/'.$Formation->image) }}" alt="image" width="120" height="120"></a>
                                                     <div class="caption">
                                                         <h2 style="font-weight: blod; color:#4466c9; font-size: 16px" ><a href="">Formation en : {{ $Formation->nom }}</a></h2>
                                                         ...
                                                         <p>  {{ $Formation->description }}   &#039;.</p>
                                                           ...
                                                           <p><a href="{{ route('form',$Formation) }}"  class="btn btn-primary btn-block" role="button">  <i class="fa fa-play"></i> Démarrer la formation</a></p>
                                                           @else
                                                           <p><a href="{{ route('formationdetails',$Formation) }}"  class="btn btn-primary btn-block" role="button">  <i class="fa fa-eye"></i> Voir la formation</a></p>
