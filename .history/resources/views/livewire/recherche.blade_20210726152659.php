                        ...
                        <div class="head_title text-center">
                            <h2 style="color: #4466c9"  >Rejoignez les meilleures formations
                               ...
                               <div  class="form" >
                                   ...
                                   <h5 style="color: #4466c9" >RECHERCHER VOTRE FORAMTION</h5>

                    <x-jet-input  style="margin-top: 16px"  wire:model="search"  id="recherche" class="block mt-1 w-full" type="search" name="search"   />
