                                    ...
                                    <div class="card-body p-0">
                                        <div class="portfolio-item">
                                            ...
                                            <div class="portfolio-overlay">
                                                ...
                                                <h4 class="text-white"><a href="{{ route('formationdetails',$Formation) }}">{{ $Formation->nom }} -  {{ $Formation->statut==1 ? "PAYANT" : "GRATUIT" }} </a>

                                                </h4>

                                                      <h4 class="text-white"><a href="javascript:void(0)">

                                                          {{ $Formation->videos_count >0 ? "il y'a $Formation->videos_count episodes "   : "il y'a $Formation->videos_count episode " }}  </a></h4>
                                                   {{-- boucle sur les formations avec leurs videos  hasMany relation --}}
