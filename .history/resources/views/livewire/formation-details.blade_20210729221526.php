               ...
               <div class="card-body p-0">
                   <div class="portfolio-item">
                       ...
                       <div class="portfolio-overlay">
                           @foreach ($format->orders as $order )
                                  @if ($order->user_id==Auth::user()->id )
                               <h4 class="text-white"><a   class="btn btn-primary btn-block" role="button" href="{{ route('formationdetails',$format) }}"><i class="fa fa-play"></i> Démarrer la formation</a></a>
                                  @endif
                           @endforeach
                               @if ($format->statut==0)
