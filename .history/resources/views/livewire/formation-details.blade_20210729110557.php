<div>
   ...
   <hr  style="text-align: center" size="1" >FORMATIONS DISPONIBLES :{{ $Formation->count() }} | <input  class="form-control col-md-6" wire:model="search" style="padding: 5px; margin-left: 20px ; " type="search" name="" id="" placeholder="RECHERCHER " > <hr>
