                           ...
                           <div class="col-md-4">
                                  ...
                                  <div class="rounded overflow-hidden shadow-md bg-gray-500 ">
                                    ...
                                    <div class="px-6 pt-1 pb-2">
                                      ...
                                      <span class="inline-block bg-gray-200 rounded-full px-3 py-1 text-sm font-semibold text-gray-700 mr-2 mb-2"> <a href="">

                                         {{ $Formation->statut==1 '<a href="" >Acheter</a>' : 'Gratuit'}} </a>
                                     </span>
