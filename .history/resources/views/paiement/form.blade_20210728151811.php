                                            ...
                                            <div class="col-md-4">
                                                <div class="shadow-md" >
                                                    <div class="thumbnail">
                                                        ...
                                                        <div class="caption">
                                                            <h2 style="font-weight: blod; color:#4466c9; font-size: 50px" ><a href="">Formation en : {{ $Formation->nom }}</a></h2>
                                                            ...
                                                            <p>  {{ $Formation->description }}   &#039;.</p>
                                                              ...
                                                              <p><a href=""  class="btn btn-primary btn-block" role="button">  <i class="fa fa-money"></i> Acheter la formation</a></p>
