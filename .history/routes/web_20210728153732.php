...
Route::get('/order/{order?}',[PayPalController::class,'form'])->name('form');
Route::post('/order',[PayPalController::class,'acheter'])->name('acheter');


  //admin user
  Route::middleware(['auth'])->group(function () {
    //   Route::resource('formation', FormationController::class);
//   Route::get('/{formation_id}', [FormationController::class,'show'])->name('formationdetails');
